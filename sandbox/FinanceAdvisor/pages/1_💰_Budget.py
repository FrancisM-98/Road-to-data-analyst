...
# ─── Page Config ─────────────────────────────────────────────
st.set_page_config(page_title="Budget · Finance Advisor", page_icon="💰", layout="wide")
...
with col1:
    salaire_net = st.number_input("Salaire net mensuel (CHF)", 0, 50_000, 6_200, 100, key="sal")
with col2:
...
with col1:
    loyer = st.number_input("Loyer / Hypothèque", 0, 10_000, 1_800, 50, key="loyer")
with col2:
    assurance_maladie = st.number_input("Assurance maladie", 0, 2_000, 380, 10, key="lamal")
with col3:
    impots_mensuels = st.number_input("Impôts (mensuel)", 0, 10_000, 850, 50, key="impots")
with col4:
    transport = st.number_input("Transport (AG, auto)", 0, 3_000, 300, 25, key="transport")
...
with col7:
    prevoyance_3a = st.number_input("3ème pilier (mensuel)", 0, 1_000, 588, 10, key="3a")
with col8:
...
col1, col2, col3, col4 = st.columns(4)
with col1:
    alimentation = st.number_input("Alimentation", 0, 5_000, 600, 25, key="alim")
with col2:
    restaurants = st.number_input("Restaurants / Sorties", 0, 3_000, 200, 25, key="resto")
with col3:
    loisirs = st.number_input("Loisirs / Sport", 0, 3_000, 150, 25, key="loisirs")
with col4:
...
st.markdown(
    ...
    <div class="footer-text">
        Finance Advisor · Module Budget · Suisse Romande
    </div>
    """,
    unsafe_allow_html=True,
)
